...
template(name="{template_name}" type="string"
     string="<%PRI%>1 %TIMESTAMP:::date-rfc3339% %HOSTNAME% %APP-NAME% %PROCID% %MSGID% [meta@easyops host=\\"{host_ip}\\" business=\\"{business_name}\\" business_id=\\"{business_id}\\" app=\\"{app_name}\\" app_id=\\"{app_id}\\" log_type=\\"{log_type}\\" log_file_path=\\"%$!metadata!filename%\\"] %msg%\\n"
 )
